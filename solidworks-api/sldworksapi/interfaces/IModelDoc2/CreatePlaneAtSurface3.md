...
parameters:
  ...
  -
    name: ProjOpt
    type: System.Boolean
    description: True to project the plane along the sketch normal toward the reference surface, false to project the plane to the nearest location on the reference surface
  -
    name: ReverseDir
    type: System.Boolean
...
- `ProjOpt` (System.Boolean): True to project the plane along the sketch normal toward the reference surface, false to project the plane to the nearest location on the reference surface

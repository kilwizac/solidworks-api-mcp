...
parameters:
  -
    name: PointCount
    type: System.Int32
    description: Number of points in the pointData array
  -
    name: PointData
    type: System.Double
...
- `PointCount` (System.Int32): Number of points in the pointData array
- `PointData` (System.Double): Set of X,Y,Z point coordinates to use in creating the spline (see Remarks )

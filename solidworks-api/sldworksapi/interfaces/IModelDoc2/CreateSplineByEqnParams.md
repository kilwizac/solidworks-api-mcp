...
parameters:
  -
    name: ParamsIn
    type: System.Object
    description: Array containing an array of doubles to use in creating the spline
docset: sldworksapi
deprecated: true
...
- `ParamsIn` (System.Object): Array containing an array of doubles to use in creating the spline

...
member: ICreatePlaneAtAngle3
returns: RefPlane
parameters:
  -
    name: Val
    type: System.Double
    description: Angle from the selected plane in radians
  -
    name: FlipDir
    type: System.Boolean
...
- `Val` (System.Double): Angle from the selected plane in radians
...
swDisplayPlanes and
IModelDocExtenison::SetUserPreferenceToggle

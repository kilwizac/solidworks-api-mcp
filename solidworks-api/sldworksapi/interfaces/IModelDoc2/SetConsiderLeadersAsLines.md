...
parameters:
  -
    name: LeadersAsLines
    type: System.Boolean
    description: True to return leaders as line data, false to not
docset: sldworksapi
deprecated: false
...
```csharp
System.Boolean SetConsiderLeadersAsLines( 
   System.Boolean
LeadersAsLines
)
```
...
- `LeadersAsLines` (System.Boolean): True to return leaders as line data, false to not

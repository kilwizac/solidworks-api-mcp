...
member: ICreatePlanePerCurveAndPassPoint3
returns: RefPlane
parameters:
  -
    name: OrigAtCurve
  ...
  -
    name: AutoSize
    type: System.Boolean
    description: True if plane is to be automatically sized, false if not
docset: sldworksapi
deprecated: true
...
- `AutoSize` (System.Boolean): True if plane is to be automatically sized, false if not

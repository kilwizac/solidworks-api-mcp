...
The document name that appears in the window header changes based on your File Explorer settings. If you chose to suppress known file extensions, then the title shown in the window, and returned by this method, varies (for example,
Part1.sldprt
vs.
Part1
)

...
parameters:
  ...
  -
    name: EdgeToleranceArray
    type: System.Object
    description: Array of tolerances for edges
  -
    name: VertexToleranceArray
    type: System.Object
  ...
  -
    ...
    type: System.Object
    description: Array of surfaces that lie on CurveArray1 2D curve
  -
    name: CurveArray2
    type: System.Object
...
- `Topologies` (System.Object): Array of topologies (see swTopoEntity_e ), one for each topological entity
- `EdgeToleranceArray` (System.Object): Array of tolerances for edges
- `VertexToleranceArray` (System.Object): Array of tolerances for vertices
- `PointArray` (System.Object): Array of coordinates of vertices (geometry for vertices)
- `CurveArray1` (System.Object): Array of curves (geometry for edges; 3D curve) and coedges (geometry for coedges; 2D curve)
- `CurveSurfaceArray1` (System.Object): Array of surfaces that lie on CurveArray1 2D curve
- `CurveArray2` (System.Object): Array of curves (geometry for edges; 3D curve) and array of coedges (geometry for coedges; 2D curve)
- `CurveSurfaceArray2` (System.Object): Array of surfaces that on lie on CurveArray2 2D curve
- `SurfaceArray` (System.Object): Array of surfaces (geometry for faces)
- `NRelations` (System.Int32): Number of 1-to-1 relationships between topological entities
- `Parents` (System.Object): Array of parents, one in each relationship
- `Children` (System.Object): Array of parents, one in each relationship
- `Senses` (System.Object): Array of senses in which child is used by parent in the relationship
...
Each face or edge created by IModeler::CreateBrepBody3 or
IModeler::ICreateBrepBody3
has an associated integer ID that is the same as the index to the input topologies. Use
IFace2::GetFaceId
or
IEdge::GetId

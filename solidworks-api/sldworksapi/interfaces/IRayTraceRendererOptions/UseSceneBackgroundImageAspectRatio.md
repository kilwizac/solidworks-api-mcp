...
keywords:
  - usescenebackgroundimageaspectratio
...
# IRayTraceRendererOptions.UseSceneBackgroundImageAspectRatio
...
```csharp
System.Boolean UseSceneBackgroundImageAspectRatio {get; set;}
```
## Parameters

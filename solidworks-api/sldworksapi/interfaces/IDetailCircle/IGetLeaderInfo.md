...
in-process, unmanaged C++: Pointer to an array (see Remarks ) VBA, VB.NET, C#, and C++/CLI: Not supported See In-process Methods for details about this type of method.

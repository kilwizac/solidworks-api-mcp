...
parameters:
  -
    name: Text
    type: System.String
    description: Text to write to a VBA macro and the SOLIDWORKS journal file
docset: sldworksapi
deprecated: false
...
- `Text` (System.String): Text to write to a VBA macro and the SOLIDWORKS journal file

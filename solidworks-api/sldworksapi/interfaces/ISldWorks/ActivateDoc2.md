...
parameters:
  ...
  -
    name: Silent
    type: System.Boolean
    description: True if dialogs and warning messages should be avoided, false if dialogs and warning messages should be displayed to the user
  -
    name: Errors
    type: System.Int32
    description: Status of the document activate operation as defined in swActivateDocError_e ; if no errors or warnings are encountered, then this value is set to 0
docset: sldworksapi
deprecated: true
...
- `Silent` (System.Boolean): True if dialogs and warning messages should be avoided, false if dialogs and warning messages should be displayed to the user
- `Errors` (System.Int32): Status of the document activate operation as defined in swActivateDocError_e ; if no errors or warnings are encountered, then this value is set to 0

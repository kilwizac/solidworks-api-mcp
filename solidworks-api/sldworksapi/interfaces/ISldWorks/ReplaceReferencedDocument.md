...
parameters:
  -
    ...
    type: System.String
    description: Document whose references to modify; the document cannot be open
  -
    name: ReferencedDocument
    type: System.String
    description: Document is referenced by ReferencingDocument; all of its references within ReferencingDocument are replaced by NewReference
  -
    name: NewReference
    type: System.String
    description: New document used by ReferencingDocument
docset: sldworksapi
deprecated: false
...
```csharp
System.Boolean ReplaceReferencedDocument( 
   System.String
ReferencingDocument
,
   System.String
...
- `ReferencingDocument` (System.String): Document whose references to modify; the document cannot be open
- `ReferencedDocument` (System.String): Document is referenced by ReferencingDocument; all of its references within ReferencingDocument are replaced by NewReference
- `NewReference` (System.String): New document used by ReferencingDocument
...
You might also notice that the component name, which is visible in the FeatureManager design tree, will not change to the name of the NewReference unless the proper user preference is set (

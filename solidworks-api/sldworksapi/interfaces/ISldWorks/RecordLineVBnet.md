...
type: method
interface: ISldWorks
member: RecordLineVBnet
returns: System.Boolean
parameters:
  -
    name: StringLine
    type: System.String
    description: Text to write to a VB.NET macro and the SOLIDWORKS journal file
docset: sldworksapi
deprecated: false
...
```csharp
System.Boolean RecordLineVBnet( 
   System.String
StringLine
)
```
...
- `StringLine` (System.String): Text to write to a VB.NET macro and the SOLIDWORKS journal file
...
SW VBA Macro (*.swp)
.
ISldWorks::RecordLineVBne to record to a

...
parameters:
  ...
  -
    name: Item
    type: System.String
    description: Description that appears on the shortcut menu item
  -
    name: CallbackFcnAndModule
    type: System.String
    description: Functions called when user clicks the shortcut menu item (see Remarks )
  -
    name: CustomNames
    type: System.String
    description: Functions called when user clicks the shortcut menu item (see Remarks )
...
- `Item` (System.String): Description that appears on the shortcut menu item
- `CallbackFcnAndModule` (System.String): Functions called when user clicks the shortcut menu item (see Remarks )
- `CustomNames` (System.String): Functions called when user clicks the shortcut menu item (see Remarks )
- `Unused` (System.Int32): Names of custom feature types (see Remarks )
- `BitmapFileName` (System.String): Names of custom feature types (see Remarks )
...
You can add a new menu to any one of the four SOLIDWORKS frames (Main frame, part frame, assembly frame, or drawing frame). To do this, you must get the
IFrame
object when the desired frame is active. For example, if you want your menu to be available when a part document is active, then call
ISldWorks::Frame

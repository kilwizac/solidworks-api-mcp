...
- `SizeOfFrontFaceList` (System.Int32): VBA, VB.NET, C#, and C++/CLI: Not supported
- `FromFaceBackListDisp` (Face2): Number of front faces
- `SizeOfBackFaceList` (System.Int32): in-process, unmanaged C++: Pointer to an array of back faces VBA, VB.NET, C#, and C++/CLI: Not supported See In-process Methods for details about this type of method.
- `Thickness` (System.Double): Number of back faces

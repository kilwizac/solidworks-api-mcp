...
parameters:
  -
    name: Flag
    type: System.Boolean
    description: True for compound note object to have no leaderline and be attached to an object, false to display leaderline
docset: sldworksapi
deprecated: true
...
```csharp
System.Boolean SetZeroLengthLeader( 
   System.Boolean
Flag
)
```
...
- `Flag` (System.Boolean): True for compound note object to have no leaderline and be attached to an object, false to display leaderline

...
parameters:
  -
    name: ArraySize
    type: System.Int32
    description: Number of arcs in the sketch
docset: sldworksapi
deprecated: false
...
- `ArraySize` (System.Int32): Number of arcs in the sketch

## Return Value

in-process, unmanaged C++: Pointer to an array of doubles containing the arcs in the sketch (see Remarks ) VBA, VB.NET, C#, and C++/CLI: Not supported See In-process Methods for details about this type of method.

...
parameters:
  -
    name: FilePath
    type: System.String
    description: Full path to the directory of the exported DXF/DWG file
  -
    name: ModelName
    type: System.String
    description: File and path name of the active part document
  -
    name: Action
    type: System.Int32
...
- `FilePath` (System.String): Full path to the directory of the exported DXF/DWG file
- `ModelName` (System.String): File and path name of the active part document
...
- `Alignment` (System.Object): Array of twelve double values that contain information related to output alignment: Array[0], Array[1], Array[2] - XYZ coordinates of new origin Array[3], Array[4], Array[5] - coordinates of new x direction vector Array[6], Array[7], Array[8] - coordinates of new y direction vector Array[9], Array[10], Array[11] - coordinates of the vector that is normal to the selected faces or loops The last three elements of the array are valid only if Action = 2
...
- `Views` (System.Object): Array of annotation view names to export; valid only if Action = 3

...
parameters:
  -
    name: NoConversion
    type: System.Boolean
    description: True prohibits converting to user units from system units, false does not
docset: sldworksapi
deprecated: false
...
- `NoConversion` (System.Boolean): True prohibits converting to user units from system units, false does not

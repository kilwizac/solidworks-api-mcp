...
```csharp
System.Int32 MemberPointParametersType {get; set;}
```
## Parameters
...
Point parameter as defined by swSecondaryMemberUpToMembersMemberPointParameters_e

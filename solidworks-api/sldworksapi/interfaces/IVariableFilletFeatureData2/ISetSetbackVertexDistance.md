...
parameters:
  ...
  -
    name: DistArr
    type: System.Double
    description: in-process, unmanaged C++: Pointer to an array of setback distances at the specified VBA, VB.NET, C#, and C++/CLI: Not supported
docset: sldworksapi
deprecated: false
...
- `Vtx` (Vertex): Vertex for which to set the setback distance
...
- `DistArr` (System.Double): in-process, unmanaged C++: Pointer to an array of setback distances at the specified VBA, VB.NET, C#, and C++/CLI: Not supported

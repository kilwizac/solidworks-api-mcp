...
parameters:
  ...
  -
    name: CustomProp
    type: System.String
    description: Custom property used to fill the values in this user-defined column
docset: sldworksapi
deprecated: false
...
- `CustomProp` (System.String): Custom property used to fill the values in this user-defined column
...
Use this method to create a user-defined column where each row in the column is automatically filled in with the custom property value for that particular configuration for that component.
The default title for the column is the name of the custom property. If the specified custom property is not a valid custom property, then each row in the column remains empty.

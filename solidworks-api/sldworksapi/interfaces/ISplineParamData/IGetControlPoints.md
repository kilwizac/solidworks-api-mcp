...
parameters:
  -
    name: Count
    type: System.Int32
    description: Size of ControlPoints array
  -
    name: ControlPoints
    type: System.Double
...
```csharp
System.Boolean IGetControlPoints( 
   System.Int32
Count
,
   out System.Double
...
- `Count` (System.Int32): Size of ControlPoints array
- `ControlPoints` (System.Double): in-process, unmanaged C++: Pointer to an array of doubles (see Remarks ) VBA, VB.NET, C#, and C++/CLI: Not supported See In-process Methods for details about this type of method.

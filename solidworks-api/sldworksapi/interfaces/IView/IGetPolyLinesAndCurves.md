...
parameters:
  ...
  -
    name: ArraySize
    type: System.Int32
    description: Size of the array of lines and parameters in the view
docset: sldworksapi
deprecated: false
...
- `ArraySize` (System.Int32): Size of the array of lines and parameters in the view

## Return Value

in-process, unmanaged C++: Pointer to an array of lines and parameters in the view (see Remarks ) VBA, VB.NET, C#, and C++/CLI: Not supported See In-process Methods for details about this type of method.
...
is that splines and ellipses returned by this method are returned as equation parameters, which are more precise definitions.

...
parameters:
  -
    name: ArraySize
    type: System.Int32
    description: Extra double for each detail circle; this array entity contains the layer ID for the detail circle, and it is the first entity in the array for each detail circle (see Remarks )
docset: sldworksapi
deprecated: false
...
- `ArraySize` (System.Int32): Extra double for each detail circle; this array entity contains the layer ID for the detail circle, and it is the first entity in the array for each detail circle (see Remarks )

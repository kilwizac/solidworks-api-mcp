...
in-process, unmanaged C++: Pointer to an array of strings with one string for each detail circle in the view VBA, VB.NET, C#, and C++/CLI: Not supported See In-process Methods for details about this type of method.

...
```csharp
System.Boolean EnableFeatureTreeWindow {get; set;}
```
## Parameters
...
, which temporarily enables or disables the FeatureManager design tree update when an add-in is running a series of operations.

...
parameters:
  ...
  -
    name: CreateSolid
    type: System.Boolean
    description: True to create a solid body, false to create a surface body; only valid when Type = 2
docset: sldworksapi
deprecated: false
...
- `CreateSolid` (System.Boolean): True to create a solid body, false to create a surface body; only valid when Type = 2
...
and the following selection marks to select the entities for a boundary feature or boundary surface feature.
Sketch curves

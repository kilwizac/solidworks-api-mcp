...
parameters:
  ...
  -
    ...
    type: System.Object
    description: Array of three doubles for the delta x, delta y, and delta z direction translation
  -
    name: RotationParams
    type: System.Object
    description: Array of six doubles: First three doubles are the x, y, and z rotation origin Last three doubles are the x, y, and z rotation angle
docset: sldworksapi
deprecated: true
...
- `TranslationParams` (System.Object): Array of three doubles for the delta x, delta y, and delta z direction translation
- `RotationParams` (System.Object): Array of six doubles: First three doubles are the x, y, and z rotation origin Last three doubles are the x, y, and z rotation angle

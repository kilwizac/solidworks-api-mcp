...
member: InsertSheetMetalGussetFeature3
returns: Feature
parameters:
  -
    name: BOffset
  ...
  -
    name: BOverrideDoc
    type: System.Boolean
    description: True to override the document flat pattern properties, false to not
  -
    name: BShowProfile
    type: System.Boolean
    description: True to display the gusset profile when flattened, false to not; valid only if BOverrideDoc is true
  -
    name: BShowCenter
    type: System.Boolean
    description: True to display the center marks when flattened, false to not; valid only if BOverrideDoc is true
docset: sldworksapi
deprecated: true
...
- `BOverrideDoc` (System.Boolean): True to override the document flat pattern properties, false to not
- `BShowProfile` (System.Boolean): True to display the gusset profile when flattened, false to not; valid only if BOverrideDoc is true
- `BShowCenter` (System.Boolean): True to display the center marks when flattened, false to not; valid only if BOverrideDoc is true

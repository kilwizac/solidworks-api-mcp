...
```csharp
System.Boolean SetStereoSeparation( 
   System.Object
DfSeparation
)
```
...
- `DfSeparation` (System.Object): Array of 2 doubles representing the stereo magnitude and stereo parallax balance settings

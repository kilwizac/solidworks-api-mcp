...
parameters:
  -
    name: Properties
    type: System.Int32
    description: in-process, unmanaged C++: Pointer to an array of properties including dimension, order, number of control points, periodicity (see Remarks ) VBA, VB.NET, C#, and C++/CLI: Not supported See In-process Methods for details about this type of method.
  -
    name: KnotArrayCount
    type: System.Int32
  ...
  -
    name: Knots
    type: System.Double
    description: in-process, unmanaged C++: Pointer to an array of knots (e.g., knot1, knot2, and so on) VBA, VB.NET, C#, and C++/CLI: Not supported
  -
  ...
  -
    name: ControlPoints
    type: System.Double
    description: in-process, unmanaged C++: Pointer to an array of control points (e.g., controlpoint1[dimension], controlpoint2[dimension], and so on) VBA, VB.NET, C#, and C++/CLI: Not supported
docset: sldworksapi
deprecated: false
...
- `Properties` (System.Int32): in-process, unmanaged C++: Pointer to an array of properties including dimension, order, number of control points, periodicity (see Remarks ) VBA, VB.NET, C#, and C++/CLI: Not supported See In-process Methods for details about this type of method.
- `KnotArrayCount` (System.Int32): Number of knots
- `Knots` (System.Double): in-process, unmanaged C++: Pointer to an array of knots (e.g., knot1, knot2, and so on) VBA, VB.NET, C#, and C++/CLI: Not supported
- `ControlPointArrayCount` (System.Int32): Number of control points
- `ControlPoints` (System.Double): in-process, unmanaged C++: Pointer to an array of control points (e.g., controlpoint1[dimension], controlpoint2[dimension], and so on) VBA, VB.NET, C#, and C++/CLI: Not supported
